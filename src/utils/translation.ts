...
import { BaseSetting, PathSetting, LocalizedSetting, DropdownItem, Dropdown } from "../renderer/types.js";
...
function _dropdownKey<T>(dropdown: Dropdown<T>, item: DropdownItem) {
...
export function translateDropdownItem<T>(dropdown: Dropdown<T>, item: DropdownItem, elementString?: string) {
