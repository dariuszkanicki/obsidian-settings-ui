...
export type Path<T, Prev extends string = "", Depth extends number = 3> = [
  Depth,
] extends [never]
  ? never
  : {
...
export type PrevDepth<D extends number> = D extends 3
  ? 2
  : D extends 2
    ? 1
    : D extends 1
...
export function getByPath<T>(obj: T, path: string): T {
